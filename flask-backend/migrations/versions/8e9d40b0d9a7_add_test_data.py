...
def upgrade():
    ...
    op.execute("""
            ...
            ('3f567e42-b743-4e5e-b33d-bc45e786aa9d', 'Главный праздник зимой в Чехии — Рождество (25 декабря). В это время города украшены огнями, а на улицах царит праздничная атмосфера. Новый год в Чехии празднуется не так активно, как в России.', 'ec71c7a4-e3e5-4c75-8e4f-8b6492aa86ac', 'f6d22210-15a2-4350-a5d2-294bacb80b11'),
