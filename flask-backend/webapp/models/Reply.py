...
class Reply(db.Model):
    ...
    parent_reply_id = db.Column(UUID(as_uuid=True), db.ForeignKey('replies.reply_id'), nullable=False)
    replies = db.relationship('Reply', remote_side=[reply_id], backref='parent_reply', lazy='dynamic')
